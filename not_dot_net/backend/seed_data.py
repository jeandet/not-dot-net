...
WORKFLOW_SEEDS = [
    ...
    {"type": "onboarding", "step": "request", "action": None, "data": {"contact_email": "lena.fischer@tu-berlin.de", "status": "PostDoc", "employer": "CNRS", "start_date": "2026-04-15"}},
    {"type": "onboarding", "step": "newcomer_info", "action": "submit", "data": {"contact_email": "james.chen@caltech.edu", "status": "Visiting Researcher", "employer": "Other", "start_date": "2026-04-01", "first_name": "James", "last_name": "Chen"}},
    {"type": "onboarding", "step": "admin_validation", "action": "submit", "data": {"contact_email": "aisha.patel@imperial.ac.uk", "status": "PhD", "employer": "Polytechnique", "start_date": "2026-05-01", "first_name": "Aisha", "last_name": "Patel", "phone": "+44 20 7946 0958", "emergency_contact": "+44 20 7946 0123"}},
    {"type": "onboarding", "step": "done", "action": "approve", "data": {"contact_email": "marco.rossi@inaf.it", "status": "Visiting Researcher", "employer": "CNRS", "start_date": "2026-03-01", "first_name": "Marco", "last_name": "Rossi", "phone": "+1 555 0101", "emergency_contact": "+1 555 0102"}},
    {"type": "onboarding", "step": "rejected", "action": "reject", "data": {"contact_email": "test@test.com", "status": "Intern", "employer": "Polytechnique", "start_date": "2026-06-01", "first_name": "Test", "last_name": "Person"}, "comment": "Position cancelled"},
    {"type": "onboarding", "step": "newcomer_info", "action": "submit", "data": {"contact_email": "sakura.yamamoto@isas.jaxa.jp", "status": "Visiting Researcher", "employer": "Other", "start_date": "2026-04-10", "first_name": "Sakura", "last_name": "Yamamoto"}},
    {"type": "onboarding", "step": "request", "action": None, "data": {"contact_email": "henrik@kth.se", "status": "PhD", "employer": "Sorbonne Université", "start_date": "2026-09-01"}},
    {"type": "onboarding", "step": "admin_validation", "action": "submit", "data": {"contact_email": "fatima.alsaid@kaust.edu.sa", "status": "PostDoc", "employer": "CNRS", "start_date": "2026-05-15", "first_name": "Fatima", "last_name": "Al-Said", "phone": "+1 555 0103", "emergency_contact": "+1 555 0104"}},
    ...
    {"type": "onboarding", "step": "done", "action": "approve", "data": {"contact_email": "wei.zhang@cas.cn", "status": "Visiting Researcher", "employer": "Other", "start_date": "2026-02-15", "first_name": "Wei", "last_name": "Zhang", "phone": "+1 555 0105", "emergency_contact": "+1 555 0106"}},
    {"type": "onboarding", "step": "newcomer_info", "action": "submit", "data": {"contact_email": "priya.sharma@iisc.ac.in", "status": "PhD", "employer": "CNRS", "start_date": "2026-06-15", "first_name": "Priya", "last_name": "Sharma"}},
