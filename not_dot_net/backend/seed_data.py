...
WORKFLOW_SEEDS = [
    ...
    {"type": "onboarding", "step": "admin_validation", "action": "submit", "data": {"person_name": "Aisha Patel", "person_email": "aisha.patel@imperial.ac.uk", "role_status": "phd_student", "team": "Theory & Simulation", "start_date": "2026-05-01", "phone": "+44 20 7946 0958", "emergency_contact": "Parent: +44 20 7946 0123"}},
    {"type": "onboarding", "step": "done", "action": "approve", "data": {"person_name": "Marco Rossi", "person_email": "marco.rossi@inaf.it", "role_status": "visitor", "team": "Instrumentation", "start_date": "2026-03-01", "phone": "+1 555 0101", "emergency_contact": "Partner: +1 555 0102"}},
    ...
    {"type": "onboarding", "step": "admin_validation", "action": "submit", "data": {"person_name": "Fatima Al-Said", "person_email": "fatima.alsaid@kaust.edu.sa", "role_status": "postdoc", "team": "Theory & Simulation", "start_date": "2026-05-15", "phone": "+1 555 0103", "emergency_contact": "Sibling: +1 555 0104"}},
    ...
    {"type": "onboarding", "step": "done", "action": "approve", "data": {"person_name": "Wei Zhang", "person_email": "wei.zhang@cas.cn", "role_status": "researcher", "team": "Instrumentation", "start_date": "2026-02-15", "phone": "+1 555 0105", "emergency_contact": "Spouse: +1 555 0106"}},
